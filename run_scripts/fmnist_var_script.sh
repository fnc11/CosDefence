...
### name the job
#SBATCH --job-name=fmnist_grad_collect_plot
### job run time
#SBATCH --time=04:00:00
### declare the merged STDOUT/STDERR file
#SBATCH --output=fmnist_grad_collect_plot_logs.%J.txt
###
...
python3 run_config_variations_ffa_grad_collect.py fmnist_modified.yaml
